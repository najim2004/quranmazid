...
export const BookmarkNavIcon = ({ size = 16, className, ...props }: IconProps) => (
  <svg
...
export const BookmarkIcon = ({ size = 16, className, ...props }: IconProps) => (
  <svg
    ...
    viewBox="0 0 16 18"
    fill="none"
    className={cn("text-icon-color size-5", className)}
    {...props}
  >
    <path d="M1.64453 13.7513V7.17862C1.64453 4.29211 1.64453 2.84886 2.57528 1.95214C3.50603 1.05542 5.00405 1.05542 8.00009 1.05542C10.9961 1.05542 12.4942 1.05542 13.4249 1.95214C14.3556 2.84886 14.3556 4.29211 14.3556 7.17862V13.7513C14.3556 15.5832 14.3556 16.4991 13.7417 16.827C12.5527 17.4618 10.3224 15.3437 9.26325 14.7059C8.64899 14.336 8.34186 14.151 8.00009 14.151C7.65832 14.151 7.35118 14.336 6.73692 14.7059C5.67777 15.3437 3.4475 17.4618 2.25852 16.827C1.64453 16.4991 1.64453 15.5832 1.64453 13.7513Z" stroke="currentColor" strokeWidth="1.38569" strokeLinecap="round" strokeLinejoin="round"></path><path d="M1.64453 5.02588H14.3556" stroke="currentColor" strokeWidth="1.38569" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
...
export const ChevronDownIcon = ({ size = 14, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    viewBox="0 0 15 14"
    fill="none"
    className={cn("size-4 shrink-0 transition-all duration-300 ease-in-out", className)}
    {...props}
  >
...
export const ChevronLeftIcon = ({ size = 15, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ChevronRightIcon = ({ size = 15, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const FontSettingsIcon = ({ size = 19, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    viewBox="0 0 19 18"
    fill="none"
    className={cn("text-subtitle-color size-5 transition-all duration-200 group-data-[state="open]:hidden"", className)}
    {...props}
  >
    <path d="M7.07031 16.5H11.5703C15.3203 16.5 16.8203 15 16.8203 11.25V6.75C16.8203 3 15.3203 1.5 11.5703 1.5H7.07031C3.32031 1.5 1.82031 3 1.82031 6.75V11.25C1.82031 15 3.32031 16.5 7.07031 16.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M5.57031 6.66749C7.93281 5.48999 10.7078 5.48999 13.0703 6.66749" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M9.32031 12.225V5.94751" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
);

export const GoToAyahIcon = ({ size = 22, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const MoreIcon = ({ size = "1em", className, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M4 12a1 1 0 1 0 2 0a1 1 0 1 0-2 0m7 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0m7 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0"></path>
  </svg>
);

export const OthersIcon = ({ size = 22, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M20.1667 7.58075V3.87742C20.1667 2.41992 19.58 1.83325 18.1225 1.83325H14.4192C12.9617 1.83325 12.375 2.41992 12.375 3.87742V7.58075C12.375 9.03825 12.9617 9.62492 14.4192 9.62492H18.1225C19.58 9.62492 20.1667 9.03825 20.1667 7.58075Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M9.62565 7.80992V3.64825C9.62565 2.35575 9.03898 1.83325 7.58148 1.83325H3.87815C2.42065 1.83325 1.83398 2.35575 1.83398 3.64825V7.80075C1.83398 9.10242 2.42065 9.61575 3.87815 9.61575H7.58148C9.03898 9.62492 9.62565 9.10242 9.62565 7.80992Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M9.62565 18.1225V14.4192C9.62565 12.9617 9.03898 12.375 7.58148 12.375H3.87815C2.42065 12.375 1.83398 12.9617 1.83398 14.4192V18.1225C1.83398 19.58 2.42065 20.1667 3.87815 20.1667H7.58148C9.03898 20.1667 9.62565 19.58 9.62565 18.1225Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M13.75 14.2083H19.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path><path d="M13.75 17.875H19.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
  </svg>
);

export const PlayIcon = ({ size = 18, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M3 9.00004V6.33004C3 3.01504 5.3475 1.65754 8.22 3.31504L10.5375 4.65004L12.855 5.98504C15.7275 7.64254 15.7275 10.3575 12.855 12.015L10.5375 13.35L8.22 14.685C5.3475 16.3425 3 14.985 3 11.67V9.00004Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
);

export const ReadQuranIcon = ({ size = 26, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const SearchIcon = ({ size = 21, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const SettingsIcon = ({ size = 19, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const TafsirIcon = ({ size = 22, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ThemeIcon = ({ size = "1em", className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path fill="currentColor" d="M11 4V1h2v3zm0 19v-3h2v3zm9-10v-2h3v2zM1 13v-2h3v2zm17.7-6.3l-1.4-1.4l1.75-1.8l1.45 1.45zM4.95 20.5L3.5 19.05l1.8-1.75l1.4 1.4zm14.1 0l-1.75-1.8l1.4-1.4l1.8 1.75zM5.3 6.7L3.5 4.95L4.95 3.5L6.7 5.3zM12 18q-2.5 0-4.25-1.75T6 12t1.75-4.25T12 6t4.25 1.75T18 12t-1.75 4.25T12 18"></path>
  </svg>
);

export const ReadingSettingsOpenIcon = ({ size = 26, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    viewBox="0 0 26 26"
    fill="none"
    className={cn("text-primary hidden size-5 transition-all duration-200 group-data-[state="open]:block"", className)}
    {...props}
  >
    <path d="M23.8333 5.05916V18.135C23.8333 19.175 22.9883 20.15 21.9483 20.28L21.5908 20.3233C19.2292 20.6375 15.5892 21.84 13.5092 22.9883C13.3683 23.075 13.195 23.1075 13 23.1075V5.74166C13.2058 5.74166 13.4117 5.68749 13.5742 5.58999L13.7583 5.47082C15.6867 4.25749 19.1425 3.09832 21.4175 2.90332H21.4825C22.7717 2.79499 23.8333 3.75916 23.8333 5.05916Z" fill="currentColor"></path><path opacity="0.4" fillRule="evenodd" clipRule="evenodd" d="M12.9993 5.74191V23.1077C12.8152 23.1077 12.6202 23.0752 12.4685 22.9886L12.4252 22.9669C10.3452 21.8294 6.71602 20.6377 4.36518 20.3236L4.05102 20.2802C3.01102 20.1502 2.16602 19.1752 2.16602 18.1352V5.04858C2.16602 3.75941 3.21685 2.78441 4.50602 2.89275C6.78102 3.07691 10.226 4.22525 12.1543 5.42775L12.4252 5.59025C12.5877 5.68774 12.7935 5.74191 12.9993 5.74191ZM8.39518 10.0103H5.95768C5.51352 10.0103 5.14518 9.64196 5.14518 9.19779C5.14518 8.75363 5.51352 8.38529 5.95768 8.38529H8.39518C8.83935 8.38529 9.20768 8.75363 9.20768 9.19779C9.20768 9.64196 8.83935 10.0103 8.39518 10.0103ZM5.95768 13.2603H9.20768C9.65185 13.2603 10.0202 12.892 10.0202 12.4478C10.0202 12.0036 9.65185 11.6353 9.20768 11.6353H5.95768C5.51352 11.6353 5.14518 12.0036 5.14518 12.4478C5.14518 12.892 5.51352 13.2603 5.95768 13.2603Z" fill="currentColor"></path>
  </svg>
);

export const iconComponentMap = {
  "bookmark-nav": BookmarkNavIcon,
  "bookmark": BookmarkIcon,
  "chevron-down": ChevronDownIcon,
  "chevron-left": ChevronLeftIcon,
  "chevron-right": ChevronRightIcon,
  "font-settings": FontSettingsIcon,
  "go-to-ayah": GoToAyahIcon,
  "home": HomeIcon,
  "logo": LogoIcon,
  "more": MoreIcon,
  "others": OthersIcon,
  "play": PlayIcon,
  "read-quran": ReadQuranIcon,
  "reading-settings": ReadingSettingsIcon,
  "search-muted": SearchMutedIcon,
  "search": SearchIcon,
  "settings": SettingsIcon,
  "support-heart": SupportHeartIcon,
  "tafsir": TafsirIcon,
  "theme": ThemeIcon,
  "reading-settings-open": ReadingSettingsOpenIcon,
};
